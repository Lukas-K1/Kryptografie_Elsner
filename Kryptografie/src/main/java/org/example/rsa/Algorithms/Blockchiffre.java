...
public class Blockchiffre {
    ...
    private static String generateCipher(String message, int charBlockLength, RSAKeys rsaKeys) throws Exception {
        ArrayList<BigInteger> blockList = unicodeToBigIntList(message, charBlockLength);
    ...
    private static String decryptCipher(String cipher, Integer blockLength, RSAKeys rsaKeys) throws Exception {
        ArrayList<BigInteger> cipherList = unicodeToBigIntList(cipher, blockLength);
    ...
    public static ArrayList<BigInteger> unicodeToBigIntList(String unicodeMessage, int blockLength) {
